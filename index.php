    ...
    <style>
        * {
        ...
        body {
            ...
            position: relative;
            overflow-x: hidden;
            background-image: url('pengguna/rainforest.jpg');
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: url('pengguna/rainforest.jpg') no-repeat center center;
            background-size: cover;
            background-position: center;
            z-index: -1;
        }
        ...
        <div class="content-left">
            ...
            <?php if (!empty($welcomeName)): ?>
                <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                    <a href="pengguna/absensi.php" class="learn-more-btn">Isi Absensi</a>
                    <a href="pengguna/mydata.php" class="learn-more-btn">Dashboard</a>
                </div>
            <?php else: ?>
                <a href="pengguna/biodata.php" class="learn-more-btn">Isi Biodata</a>
            <?php endif; ?>
        </div>
    </main>
